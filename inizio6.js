...
function startGame() {
    ...
    imagine1 = new component(170, 80, "img/pp2.png", 64, 129,"image");
    imagine2 = new component(100, 80, "img/i4.png", 64, 129,"image");
    imagine3 = new component(100, 80, "img/pp4.png", 64, 129,"image");
    ...
    imagine11 = new component(100, 80, "img/bb3.png", 64, 129,"image");
    imagine12 = new component(100, 80, "img/i2.png", 64, 129,"image");
    myGamePiece.gravity = 2;
    t = new component(2000, 200, "img/tttt.png", 0, 770,"image");
    musica = new sound('musica/water.mp3');
    ...
    myBackground = new component(2000, 1200, "img/water.png", 0, -410, "background");
    myGameArea.start();
}
...
function updateGameArea() {
    ...
    if (myGameArea.frameNo == 1 || everyinterval(100)) {
        ...
        nemici1.push(new component(100, 100, "img/pp.png", x, y, "image"));
    }
    ...
    if (myGameArea.frameNo == 1 || everyinterval(100)) {
        ...
        y = myGameArea.canvas.height - num;
        nemici2.push(new component(100, 100, "img/pp3.png", x, y, "image"));
    }
    ...
    if (myGameArea.frameNo == 1 || everyinterval(100)) {
        ...
        x = myGameArea.canvas.width;
        y = myGameArea.canvas.height -num;
        nemici3.push(new component(100, 100, "img/i3.png", x, y, "image"));
    }
    ...
    if (myGameArea.frameNo == 1 || everyinterval(100)) {
        ...
        x = myGameArea.canvas.width - 2300;
        y = myGameArea.canvas.height -num;
        nemici4.push(new component(100, 100, "img/i.png", x, y, "image"));
    }
    ...
    if(myGameArea.frameNo>900){
        ...
        if (myGameArea.frameNo == 1 || everyinterval(100)) {
            ...
            x = myGameArea.canvas.width;
            y = myGameArea.canvas.height -num;
            nemici5.push(new component(100, 150, "img/bb2.png", x, y, "image"));
        }
...
//fuoco oro
    ...
    for (i = 0; i < nemici1.length; i += 1) {
        ...
        if (n == 1) {
            nemici1[i].image.src = "img/pp.png";
        } 
        if (n == 2) {
            nemici1[i].image.src = "img/pp2.png";
        } 
    ...
    for (i = 0; i < nemici2.length; i += 1) {
        let n = Math.floor(Math.random() * 2) + 1;
        if (n == 1) {
            nemici2[i].image.src = "img/pp3.png";
        } 
        if (n == 2) {
            nemici2[i].image.src = "img/pp4.png";
        } 
        if (myGamePiece.crashWith(nemici2[i])) {
                myGameArea.vitaMario-=1;
                suono7.play();
        }
        if (fuoco.crashWith(nemici2[i])) {nemici2[i].x=+10000;myGameArea.punti+=100;suono3.play();fuoco.x=myGamePiece.x;fuoco.y=myGamePiece.y+70;}
        if (fuoco2.crashWith(nemici2[i])) {nemici2[i].x=+10000;myGameArea.punti+=100;suono3.play();fuoco2.x=myGamePiece.x;fuoco2.y=myGamePiece.y+70;}
        nemici2[i].x += 9;
        nemici2[i].update();

        if (fuoco3.crashWith(nemici2[i])) {nemici2[i].x=+10000;myGameArea.punti+=100;suono3.play();}
        if (fuoco4.crashWith(nemici2[i])) {nemici2[i].x=+10000;myGameArea.punti+=100;}
if (fuoco5.crashWith(nemici2[i]) || fuoco6.crashWith(nemici2[i])) {
    ...
    for (i = 0; i < nemici3.length; i += 1) {
        let n = Math.floor(Math.random() * 2) + 1;
        if (n == 1) {
            nemici3[i].image.src = "img/i3.png";
        } 
        if (n == 2) {
            nemici3[i].image.src = "img/i4.png";
        } 
        ...
        nemici3[i].x += -18;
        nemici3[i].update();
      if (fuoco.crashWith(nemici3[i])) {nemici3[i].x=-10000;myGameArea.punti+=100;suono3.play();fuoco.x=myGamePiece.x;fuoco.y=myGamePiece.y+70;}
      if (fuoco2.crashWith(nemici3[i])) { nemici3[i].x=-10000; myGameArea.punti+=100;suono3.play();fuoco2.x=myGamePiece.x;fuoco2.y=myGamePiece.y+70;}
      if (fuoco3.crashWith(nemici3[i]) || fuoco4.crashWith(nemici3[i])) {nemici3[i].x=-10000; myGameArea.punti+=100;suono3.play();}
      if (fuoco5.crashWith(nemici3[i]) || fuoco6.crashWith(nemici3[i])) {nemici3[i].x=-10000;myGameArea.punti+=100;suono3.play();}
        if(nemici3[i].x<1){
            nemici3.splice(i, 1);
            i--; 
        }
    ...
    for (i = 0; i < nemici4.length; i += 1) {
        let n = Math.floor(Math.random() * 2) + 1;
        if (n == 1) {
            nemici4[i].image.src = "img/i.png";
        } 
        if (n == 2) {
            nemici4[i].image.src = "img/i2.png";
        } 
        ...
        nemici4[i].x += 18;
        nemici4[i].update();
      if (fuoco.crashWith(nemici4[i])) {nemici4[i].x=-10000;myGameArea.punti+=100;suono3.play();fuoco.x=myGamePiece.x;fuoco.y=myGamePiece.y+70;}
      if (fuoco2.crashWith(nemici4[i])) { nemici4[i].x=-10000; myGameArea.punti+=100;suono3.play();fuoco2.x=myGamePiece.x;fuoco2.y=myGamePiece.y+70;}
      if (fuoco3.crashWith(nemici4[i]) || fuoco4.crashWith(nemici4[i])) {nemici4[i].x=-10000; myGameArea.punti+=100;suono3.play();}
      if (fuoco5.crashWith(nemici4[i]) || fuoco6.crashWith(nemici4[i])) {nemici4[i].x=-10000;myGameArea.punti+=100;suono3.play();}
        if(nemici4[i].x>2011){
            nemici4.splice(i, 1);
            i--; 
        }
    ...
    for (i = 0; i < nemici5.length; i += 1) {
        ...
        var speed =7;
        if (n == 1) {
            nemici5[i].image.src = "img/bb2.png";
        } 
        if (n == 2) {
            nemici5[i].image.src = "img/bb3.png";
        } 
        ...
        var deltaX = myGamePiece.x - nemici5[i].x;
        var deltaY = myGamePiece.y - nemici5[i].y;
        var angle = Math.atan2(deltaY, deltaX);
        nemici5[i].x += speed * Math.cos(angle);
        nemici5[i].y += speed * Math.sin(angle);
        nemici5[i].update();
    

if (fuoco.crashWith(nemici5[i])) {nemici5[i].x=-10000;myGameArea.punti+=100;suono3.play();fuoco.x=myGamePiece.x;fuoco.y=myGamePiece.y+70;}
if (fuoco2.crashWith(nemici5[i])) {nemici5[i].x=-10000;myGameArea.punti+=100;suono3.play();fuoco2.x=myGamePiece.x;fuoco2.y=myGamePiece.y+70;}
if (fuoco3.crashWith(nemici5[i]) || fuoco4.crashWith(nemici5[i])) {nemici5[i].x=-10000; myGameArea.punti+=100;suono3.play();}
if (fuoco5.crashWith(nemici5[i]) || fuoco6.crashWith(nemici5[i])) {nemici5[i].x=-10000;myGameArea.punti+=100;suono3.play();}

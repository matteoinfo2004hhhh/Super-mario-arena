...
function s2(){
    if(myGameArea.monetar>100){
        suono4.play();
        myGameArea.vitaMario+=10;
        myGameArea.monetar-=100;
    }
}
...
function s4(){
    if(myGameArea.monetar>10000){
        ...
        myGameArea.monetar-=5000;
    }
}

function s5(){
    if(myGameArea.monetar>2500){
        suono4.play();
...
function s6(){
    if(myGameArea.monetar>6000){
        suono4.play();
        myGameArea.vitaMariof2+=100;
        myGameArea.vitaMariof=0;
        myGameArea.monetar-=6000;
    }
}

function s7(){
    if(myGameArea.monetar>100000){
        suono4.play();
